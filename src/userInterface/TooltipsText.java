...
public interface TooltipsText {
	...
	public static final String PEAK_REDUCTION_DESCRIPTION = "Increase to reduce the maximum amount of force sent to your steering wheel by introducing soft clipping.";
	public static final String POWER_ENHANCEMENT_DESCRIPTION = "Increase to boost your wheel FFB strength. This option increases the low and medium values of FFB in a progressive manner by introducing soft clipping.";
	public static final String DZ_ENHANCEMENT_DESCRIPTION = "Increase if you have vibrations in the central area of the steering wheel, decrease if you still have a FFB dead zone with the generated lut.";
