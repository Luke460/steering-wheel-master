...
This procedure uses as input a log file generated by ***iRacing force feedback test***, and by processing it, is able to produce a lookup table (or ***lut file***).
